...
def edit_data(): 
    ...
    for item in dict_edit.items():
        ...
        """ In the final program component this component will call the delete
        function so that this component will actually delete the old data and add the new data
        """
